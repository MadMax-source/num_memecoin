            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-black">ABOUT THE NUM PROJECT</h2>
                    </div>

                    {/* Project Intro */}
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-md mb-12">
...
function Section({ title, children }: { title: string, children: React.ReactNode }) {
    return (
        <div className="mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-black mb-6 text-center">{title}</h3>
            <ul className="list-disc list-inside text-black text-lg md:text-xl leading-relaxed space-y-3 bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-md">
                {children}
            </ul>
        </div>
    )
